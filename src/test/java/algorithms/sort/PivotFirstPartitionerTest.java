...
import algorithms.sort.impl.PivotFirstPartitioner;
...
public class PivotFirstPartitionerTest {

	@InjectMocks
	private PivotFirstPartitioner<String> pivotFirstPartitioner;
	...
	public void partition_distinctElements() {
		...
		final String[] actualArray = pivotFirstPartitioner.partition(initialArray);
